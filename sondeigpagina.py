...
def main():
    ...
    # --- INFO ADDICIONAL ---
    with st.expander("ℹ️ Sobre aquesta aplicació"):
        st.markdown("""
        Aquesta eina visualitza i analitza sondejos atmosfèrics mitjançant un diagrama Skew-T Log-P.
        
        **Característiques principals:**
        - **Visualització Completa**: Diagrama Skew-T amb perfils de temperatura, punt de rosada, adiabàtiques, etc.
        - **Anàlisi Automàtica**: Genera un "xat" interpretatiu simulat sobre les condicions atmosfèriques.
        - **Panells Gràfics**: Inclou simulacions d'eco de radar, estructura de núvols, visualització de la base i avisos públics.
        - **Controls Interactius**: Ajusta paràmetres com la pressió en superfície o la convergència des de la barra lateral.
        
        **Com utilitzar-la:**
        1.  **Puja un fitxer** de sondeig en format text o **selecciona un dels exemples locals** disponibles.
        2.  L'aplicació carregarà i analitzarà les dades automàticament.
        3.  Fes servir els controls a la barra lateral per **modificar els paràmetres** i veure com afecten la predicció.
        
        Aquesta aplicació ha estat adaptada a Streamlit a partir d'un script original de Matplotlib.
        """)
