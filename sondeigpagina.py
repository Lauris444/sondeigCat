...
"tutorial_supercell_step1_instr": "Necessitem energia. La manera més comuna és l'escalfament del sol durant el dia. Fes clic al botó de sota per escalfar les capes de superfície.",
"tutorial_supercell_step1_button": "☀️ Escalfar Superfície",
"tutorial_supercell_step1_expl": "Això augmenta la temperatura a prop de la superfície, creant una 'bombolla' d'aire que voldrà ascendir.",
"tutorial_supercell_step2_title": "Pas 2: Afegeix el combustible explosiu",
"tutorial_supercell_step2_instr": "Una tempesta severa necessita molta humitat. Farem una injecció massiva d'humitat a les capes baixes per disparar el potencial.",
"tutorial_supercell_step2_button": "💧🌊 Injectar Humitat Massiva",
"tutorial_supercell_step2_expl": "Veuràs com el valor de CAPE es dispara a nivells extrems. Aquesta és l'energia real que alimenta les supercèl·lules.",
"tutorial_supercell_step3_title": "Pas 3: Afegeix el motor de rotació",
"tutorial_supercell_step3_instr": "Ara afegirem vent de sud-oest que s'intensifica amb l'altura a les capes mitjanes. Això inicia la rotació.",
"tutorial_supercell_step3_button": "🌪️ Afegir Vent del SW a Capes Mitjanes",
"tutorial_supercell_step3_expl": "Un canvi en la direcció i velocitat del vent amb l'altura és crucial per a que la tempesta comenci a rotar.",
"tutorial_supercell_step4_title": "Pas 4: Potencia el Jet Stream",
"tutorial_supercell_step4_instr": "Finalment, intensifiquem el vent a les capes altes per donar-li a la supercèl·lula la 'respiració' que necessita per sobreviure i fer-se severa.",
"tutorial_supercell_step4_button": "✈️ Intensificar el Jet Stream",
"tutorial_supercell_step4_expl": "Això ajuda a evacuar l'aire de la part superior de la tempesta, reforçant el corrent ascendent i fent-la molt més potent i duradora.",
"tutorial_supercell_step5_title": "Anàlisi Final",
"tutorial_supercell_step5_instr": "Missió complerta! Has creat un perfil amb molta energia (CAPE), humitat i un fort cisallament organitzat. Fixa't com han augmentat els paràmetres de cisallament (Shear) i helicitat (SRH).",
...
"tutorial_supercell_step1_expl": "Esto aumenta la temperatura cerca de la superficie, creando una 'burbuja' de aire que querrá ascender.",
"tutorial_supercell_step2_title": "Paso 2: Añade el combustible explosivo",
"tutorial_supercell_step2_instr": "Una tormenta severa necesita mucha humedad. Haremos una inyección masiva de humedad en las capas bajas para disparar el potencial.",
"tutorial_supercell_step2_button": "💧🌊 Inyectar Humedad Masiva",
"tutorial_supercell_step2_expl": "Verás cómo el valor de CAPE se dispara a niveles extremos. Esta es la energía real que alimenta las supercélulas.",
"tutorial_supercell_step3_title": "Paso 3: Añade el motor de rotación",
"tutorial_supercell_step3_instr": "Ahora añadiremos viento del suroeste que se intensifica con la altura en las capas medias. Esto inicia la rotación.",
"tutorial_supercell_step3_button": "🌪️ Añadir Viento del SW en Capas Medias",
"tutorial_supercell_step3_expl": "Un cambio en la dirección y velocidad del viento con la altura es crucial para que la tormenta comience a rotar.",
"tutorial_supercell_step4_title": "Paso 4: Potencia la Corriente en Chorro (Jet Stream)",
"tutorial_supercell_step4_instr": "Finalmente, intensificamos el viento en las capas altas para darle a la supercélula la 'respiración' que necesita para sobrevivir y volverse severa.",
"tutorial_supercell_step4_button": "✈️ Intensificar el Jet Stream",
"tutorial_supercell_step4_expl": "Esto ayuda a evacuar el aire de la parte superior de la tormenta, reforzando la corriente ascendente y haciéndola mucho más potente y duradera.",
"tutorial_supercell_step5_title": "Análisis Final",
"tutorial_supercell_step5_instr": "¡Misión cumplida! Has creado un perfil con mucha energía (CAPE), humedad y una fuerte cizalladura organizada. Fíjate cómo han aumentado los parámetros de cizalladura (Shear) y helicidad (SRH).",
"tutorial_supercell_step5_button": "Finalizar Tutorial",
"tutorial_supercell_step5_expl": "Este es un entorno clásico para el desarrollo de supercélulas que pueden producir tiempo severo.",
...
"tutorial_supercell_step1_instr": "We need energy. The most common way is heating from the sun during the day. Click the button below to heat the surface layers.",
"tutorial_supercell_step1_button": "☀️ Heat Surface",
"tutorial_supercell_step1_expl": "This increases the temperature near the surface, creating a 'bubble' of air that will want to rise.",
"tutorial_supercell_step2_title": "Step 2: Add the Explosive Fuel",
"tutorial_supercell_step2_instr": "A severe storm needs a lot of moisture. We will perform a massive moisture injection in the low levels to boost the potential.",
"tutorial_supercell_step2_button": "💧🌊 Inject Massive Moisture",
"tutorial_supercell_step2_expl": "You will see the CAPE value shoot up to extreme levels. This is the real energy that fuels supercells.",
"tutorial_supercell_step3_title": "Step 3: Add the Rotation Engine",
"tutorial_supercell_step3_instr": "Now we will add a southwest wind that intensifies with height in the mid-levels. This initiates rotation.",
"tutorial_supercell_step3_button": "🌪️ Add SW Wind to Mid-Levels",
"tutorial_supercell_step3_expl": "A change in wind direction and speed with height is crucial for the storm to start rotating.",
"tutorial_supercell_step4_title": "Step 4: Enhance the Jet Stream",
"tutorial_supercell_step4_instr": "Finally, we intensify the wind in the upper layers to give the supercell the 'breathing room' it needs to survive and become severe.",
"tutorial_supercell_step4_button": "✈️ Intensify Jet Stream",
"tutorial_supercell_step4_expl": "This helps to evacuate air from the top of the storm, strengthening the updraft and making it much more powerful and long-lasting.",
"tutorial_supercell_step5_title": "Final Analysis",
"tutorial_supercell_step5_instr": "Mission complete! You have created a profile with high energy (CAPE), moisture, and strong, organized shear. Notice how the shear and helicity (SRH) parameters have increased.",
"tutorial_supercell_step5_button": "Finish Tutorial",
"tutorial_supercell_step5_expl": "This is a classic environment for the development of supercells that can produce severe weather.",
